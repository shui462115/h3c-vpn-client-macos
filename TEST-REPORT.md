...
- The v0.9.7 GUI checks the GitHub latest stable release asynchronously at launch and provides manual checks from both the application menu and menu-bar menu.
...
- The final v0.9.7 app and bundled updater compiled without warnings for arm64 macOS 13.0, and the complete app passed deep strict code-signature verification.
