...
struct UpdatePackageTests {
    ...
    static func main() async throws {
        ...
        let release = UpdateRelease(
            version: "0.9.9",
            assetURL: URL(string: "https://github.com/shui462115/h3c-vpn-client-macos/releases/download/v0.9.9/\(updateAssetName)")!,
            assetSize: size,
            sha256: digest,
            releaseURL: URL(string: "https://github.com/shui462115/h3c-vpn-client-macos/releases/tag/v0.9.9")!
        )
        ...
        try validateUpdateApplication(at: app, expectedVersion: "0.9.9")
        ...
        mustThrow("wrong bundle identifier accepted") {
            try validateUpdateApplication(at: wrongIdentity, expectedVersion: "0.9.9")
        }
        ...
        mustThrow("broken code signature accepted") {
            try validateUpdateApplication(at: brokenSignature, expectedVersion: "0.9.9")
        }
